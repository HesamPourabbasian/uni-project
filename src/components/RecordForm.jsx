...
const RecordForm = ({ addRecord }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      setError("شماره دانشجویی باید حداکثر ۱۴ عدد داشته باشد");
      return;
    }
  ...
  const isValidKey = (key) => {
    ...
    const numericKey = parseInt(keyInEnglish, 10);
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (
              ...
              const keyInEnglish = convertedValue.replace(
                /[\u06F0-\u06F9]/g,
                (persianDigit) => persianToEnglishMap[persianDigit]
              );
